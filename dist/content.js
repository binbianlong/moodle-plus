function P(e){try{return new URL(e,location.href).toString()}catch{return e}}function F(e){const t=e.closest('section, .block, [role="region"], .card, .content');return t?/最近アクセスされたアイテム/.test(t.textContent??""):!1}function R(e){const t=e.getAttribute("href")??"";return t?t.includes("course/view.php?id=")?!0:t.includes("assign/view.php")||t.includes("mod/assign/")?!1:!!(F(e)&&(t.includes("course/view.php")||t.includes("/mod/")&&!t.includes("assign"))):!1}function K(e){let t=new Map,r=null;const o=()=>{const n=new Map,p=document.querySelectorAll("a[href]");for(const a of p){if(!R(a))continue;const b=(a.textContent??"").trim(),g=a.href;if(!b||!g)continue;const u=P(g);n.has(u)||n.set(u,{title:b,url:u})}t=n};return o(),r=new MutationObserver(()=>{o()}),r.observe(document.body,{childList:!0,subtree:!0,attributes:!0,attributeFilter:["href"]}),{findByAnchor(n){if(!R(n))return null;const p=P(n.href);return t.get(p)??null},disconnect(){r==null||r.disconnect(),r=null}}}const $="timetable_v1",M=["mon","tue","wed","thu","fri","sat"],N=["p1","p2","p3","p4","p5","other"];function z(){return{mon:{p1:null,p2:null,p3:null,p4:null,p5:null,other:null},tue:{p1:null,p2:null,p3:null,p4:null,p5:null,other:null},wed:{p1:null,p2:null,p3:null,p4:null,p5:null,other:null},thu:{p1:null,p2:null,p3:null,p4:null,p5:null,other:null},fri:{p1:null,p2:null,p3:null,p4:null,p5:null,other:null},sat:{p1:null,p2:null,p3:null,p4:null,p5:null,other:null}}}async function G(){var o;const t=(await chrome.storage.local.get($))[$];if(!t||typeof t!="object")return z();const r=z();for(const n of M)for(const p of N){const a=(o=t==null?void 0:t[n])==null?void 0:o[p];a&&typeof a=="object"&&typeof a.title=="string"&&typeof a.url=="string"&&(r[n][p]={title:a.title,url:a.url})}return r}async function Y(e){await chrome.storage.local.set({[$]:e})}const V={mon:"月",tue:"火",wed:"水",thu:"木",fri:"金",sat:"土"},J={p1:"1",p2:"2",p3:"3",p4:"4",p5:"5",other:"その他"};function x(e,t,r){for(const o of t){const n=e.getPropertyValue(o).trim();if(n)return n}return r}function Q(){const e=getComputedStyle(document.documentElement),t=x(e,["--body-bg","--bs-body-bg"],"#f8f9fa"),r=x(e,["--card-bg","--bs-card-bg","--bs-white"],"#ffffff"),o=x(e,["--border-color","--bs-border-color","--gray-300"],"#d9dee4"),n=x(e,["--body-color","--bs-body-color","--gray-900"],"#2b3138"),p=x(e,["--secondary","--bs-secondary-color","--gray-600"],"#5f6b7a"),a=x(e,["--primary","--bs-primary"],"#0f6cbf"),b=x(e,["--primary-600","--bs-primary-text-emphasis"],"#0c5a9f");return`
  ...
  `;const n=document.createElement("div");n.className="mpt-wrap";const p=document.createElement("div");p.className="mpt-header";const a=document.createElement("div");a.className="mpt-title-group";const b=document.createElement("div");b.className="mpt-title",b.textContent="時間割";const g=document.createElement("div");g.className="mpt-message";const u=document.createElement("button");u.className="mpt-btn",u.type="button",u.addEventListener("click",()=>e.onToggleEdit()),a.append(b,g),p.append(a,u);const k=document.createElement("table");k.className="mpt-table",n.append(p,k),r.append(o,n);const B=new Map;(()=>{k.innerHTML="";const l=document.createElement("tr"),i=document.createElement("th");i.textContent="",l.appendChild(i);for(const s of M){const m=document.createElement("th");m.textContent=V[s],l.appendChild(m)}k.appendChild(l);for(const s of N){const m=document.createElement("tr"),f=document.createElement("th");f.className="mpt-period",f.textContent=J[s],m.appendChild(f);for(const S of M){const d=document.createElement("td");d.className="mpt-cell",d.dataset.day=S,d.dataset.period=s,d.addEventListener("click",()=>e.onSelectCell({day:S,period:s})),m.appendChild(d),B.set(`${S}:${s}`,d)}k.appendChild(m)}})();const j=(l,i,s)=>{var O,q;const m=l.dataset.day,f=l.dataset.period;l.innerHTML="";const S=((O=s.selectedCell)==null?void 0:O.day)===m&&((q=s.selectedCell)==null?void 0:q.period)===f;l.classList.toggle("mpt-selected",!!S);const d=document.createElement("div");if(d.className="mpt-cell-inner",!i){const c=document.createElement("span");c.className="mpt-empty",c.textContent=s.editMode?"クリックして選択":" ",d.appendChild(c),l.appendChild(d);return}const h=document.createElement("a");if(h.className="mpt-lesson-link",h.textContent=i.title,h.href=i.url,h.dataset.url=i.url,s.editMode?h.addEventListener("click",c=>{c.preventDefault(),c.stopPropagation()}):h.addEventListener("click",c=>{c.preventDefault(),e.onOpenLesson(i)}),d.appendChild(h),l.appendChild(d),s.editMode){const c=document.createElement("button");c.className="mpt-remove",c.type="button",c.textContent="x",c.setAttribute("aria-label","授業を削除"),c.addEventListener("click",D=>{D.preventDefault(),D.stopPropagation(),e.onRemoveCell({day:m,period:f})}),l.appendChild(c)}};return{mount(l){var i;(i=l.parentNode)==null||i.insertBefore(t,l)},render(l,i){g.textContent=i.message,g.classList.toggle("mpt-show",!!i.message),u.textContent=i.editMode?"編集を終える":"編集する",u.classList.remove("mpt-btn-primary","mpt-btn-secondary"),u.classList.add(i.editMode?"mpt-btn-secondary":"mpt-btn-primary");for(const s of M)for(const m of N){const f=B.get(`${s}:${m}`);f&&j(f,l[s][m],i)}}}}let E=z(),y=!1,w=null,C="",L=!1,A=!1;const T=W({onToggleEdit:()=>{y=!y,y?(C="枠を選んでください",Z()):(w=null,C="",_()),v()},onSelectCell:e=>{y&&(w=e,C="ダッシュボードから授業を入力してください",v())},onRemoveCell:async({day:e,period:t})=>{E[e][t]=null,await Y(E),v()},onOpenLesson:e=>{window.location.href=e.url}}),H=K();function v(){T.render(E,{editMode:y,selectedCell:w,message:C})}function X(e){if(!w){C="枠を選んでください",v();return}E[w.day][w.period]=e,Y(E).catch(t=>{console.error("[mpt] failed to save timetable",t)}),C=`設定: ${e.title}`,v()}function U(e){if(!y)return;const t=e.target;if(!(t instanceof Element))return;const r=t.closest("a[href]");if(!(r instanceof HTMLAnchorElement))return;const o=H.findByAnchor(r);o&&(e.preventDefault(),e.stopPropagation(),e.stopImmediatePropagation(),X(o))}function Z(){A||(document.addEventListener("click",U,!0),A=!0)}function _(){A&&(document.removeEventListener("click",U,!0),A=!1)}function ee(){const e=Array.from(document.querySelectorAll('h1, h2, h3, h4, [role="heading"], .card-title, .header'));for(const r of e){if(!(r.textContent??"").trim().includes("コース概要"))continue;return r.closest('section, .block, .card, .container-fluid, [role="region"]')??r}const t=Array.from(document.querySelectorAll('[aria-label*="コース概要"], section, .block, .card, [role="region"]'));for(const r of t){const o=(r.getAttribute("aria-label")??"").trim(),n=(r.textContent??"").trim();if(o.includes("コース概要")||n.includes("コース概要"))return r}return null}function te(){return document.querySelector('[role="main"] .container-fluid')||document.querySelector('[role="main"]')||document.querySelector("main .container-fluid")||document.querySelector("main")||document.querySelector("#page-content")||document.body.firstElementChild}function I(){if(L)return!0;if(document.querySelector(".mpt-host"))return L=!0,!0;const e=ee();if(e&&e.parentElement)return T.mount(e),L=!0,!0;const t=te();if(t){const r=document.createElement("div");return t.insertAdjacentElement("afterbegin",r),T.mount(r),r.remove(),L=!0,!0}return!1}function re(){if(I()){v();return}const e=new MutationObserver(()=>{I()&&(v(),e.disconnect())});e.observe(document.documentElement,{childList:!0,subtree:!0})}async function ne(){location.pathname==="/my/courses.php"&&(E=await G(),re(),window.addEventListener("beforeunload",()=>{_(),H.disconnect()}))}ne();
